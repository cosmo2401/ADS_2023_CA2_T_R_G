...
template <class T>
void DListIterator<T>::operator++(int u) {
	this->advance();
}
...
template <class T>
bool DListIterator<T>::operator==(DListIterator i) {
	return currentNode->data == i.currentNode->data;
}
